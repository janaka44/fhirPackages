...
function treeBoxes(urlService, jsonData)
{
	...
	var rectNode = { width : 300, height : 65, textMargin : 5 },
	...
	// 1) ******************* Update the nodes *******************
		...
		.append('xhtml').html(function(d) {
					return '<div style="width: '
							...
							+ '' + d.nodeName + '<br><br>'
							+ '<span style="border:1px solid gray; color:gray; background-color:#efefef; padding:3px; border-radius:3px;"><small>' + d.label + '</small></span><br>'
							+ '</div>';
				})
